        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'succes') {
              (0, _alerts.showAlert)('success', 'Inicio de sesion exitoso');
          ...
          case 9:
            ...
            (0, _alerts.showAlert)('error', 'Error, vuelva a intentarlo');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            if (res.status === 200) {
              (0, _alerts.showAlert)('success', 'Si el correo existe en nuestro sitio, se enviara un codigo de restauración de contraseña');
              window.setTimeout(function () {
                location.assign('/');
              }, 2500);
            }
          ...
          case 9:
            ...
            (0, _alerts.showAlert)('error', 'No existe ninguna cuenta asociada a ese correo!');
...
var resetPassword = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(password, passwordConfirm, code) {
    var res;
        ...
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return (0, _axios.default)({
              ...
              url: "/api/v1/users/resetPassword/".concat(code),
              data: {
                password: password,
          ...
          case 4:
            ...
            if (res.status === 200) {
              (0, _alerts.showAlert)('success', 'Se actualizo la contraseña');
              window.setTimeout(function () {
                location.assign('/');
              }, 2500);
            }
          ...
          case 9:
            ...
            (0, _alerts.showAlert)('error', 'Hubo un error, intenta de nuevo!');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'succes') {
              (0, _alerts.showAlert)('success', 'Registro exitoso');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
          ...
          case 9:
            _context.prev = 9;
            _context.t0 = _context["catch"](1);
            (0, _alerts.showAlert)('error', 'Registro fallo, intenta de nuevo');
